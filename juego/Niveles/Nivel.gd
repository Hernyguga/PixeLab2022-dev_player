...
func crear_contenedores() -> void:
	...
	contenedor_sector_meteoritos.name = "ContenedorSectorMetoritos"
...
func transicion_camaras(desde:Vector2, hasta:Vector2, camara_actual:Camera2D, tiempo_transiciom_camara:float) -> void:
